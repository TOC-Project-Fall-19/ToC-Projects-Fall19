...
public class CameraScript : MonoBehaviour {
        ...
        if (Physics.Raycast(vect1, dir, out rayOut))
        {
            ...
            if (Input.GetKeyDown(KeyCode.Space)&&(!(accepted_image.activeInHierarchy||rejected_image.activeInHierarchy)))
            {
                ...
                if (list != null && list.Count == 3)
                {
                    ...
                    {
                        this.SoundObject.GetComponent<AudioSource>().PlayOneShot(Resources.Load("Audio/G1_TapeValueChanged") as AudioClip);
                    }
                    else
                    {
                        this.SoundObject.GetComponent<AudioSource>().PlayOneShot(Resources.Load("Audio/G1_HeadMoveSound") as AudioClip);
                    }
                    ...
                    if (state == finalState)
                    {
                        ...
                        this.SoundObject.GetComponent<AudioSource>().PlayOneShot(Resources.Load("Audio/G1_AcceptedString") as AudioClip);
                ...
                else
                {
                    ...
                    this.SoundObject.GetComponent<AudioSource>().PlayOneShot(Resources.Load("Audio/G1_RejectedString") as AudioClip);
    ...
    public void Dismiss()
    {
        SoundObject.GetComponent<AudioSource>().PlayOneShot(Resources.Load("Audio/G1_dismissSound") as AudioClip);
        StartCoroutine(WaitAndLoadScene(UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex));
    }
    public void GoToMainMenu()
    {
        SoundObject.GetComponent<AudioSource>().PlayOneShot(Resources.Load("Audio/G1_menuButtonClick") as AudioClip);
        StartCoroutine(WaitAndLoadScene(4));
    }
    public void OnKeyChanged()
    {
        SoundObject.transform.GetComponent<AudioSource>().PlayOneShot(Resources.Load("Audio/G1_OnKeyChanged") as AudioClip);
    }
